...
function getData() {
    ...
    */
    ...
    .then((data) => {
        ...
        let x = data.statewise[0].lastupdatedtime.split(' ');
        let z = x[0].split('/')
        let y = x[1].split(':');
        let b = z[1].split('');
        let a = parseInt(b[1]);
        ...
        div1.style = "background-image: linear-gradient(to right, rgba(255,0,0,0.34), rgba(255,0,0,0))";
        const confirmed1 = document.createElement('h4');
        confirmed1.className = 'text-center text-warning mt-3';
        confirmed1.innerText = 'Confirmed';
        div1.appendChild(confirmed1);
        const incConf = document.createElement('p');
        incConf.className = 'text-center text-warning';
        ...
        caseConf.className = 'text-center text-warning';
        ...
        div2.style = "background-image: linear-gradient(to right, rgba(240, 255, 0, 0.34), rgba(240,255,0,0))";
        const active1 = document.createElement('h4');
        active1.className = 'text-center text-primary mt-4';
        active1.innerText = 'Active';
        div2.appendChild(active1);
        const caseAct = document.createElement('p');
        caseAct.className = 'text-center text-primary';
        ...
        div3.style = "background-image: linear-gradient(to right, rgba(0, 255, 0, 0.29), rgba(0,255,0,0))";
        ...
        div4.style = "background-image: linear-gradient(to right,rgba(192,192,192,0.34) , rgba(192,192,192,0)";
